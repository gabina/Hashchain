...
\begin{proof}
  ...
  % una
  % petición \<CheckTx>($t$) -en donde $t = (h, s)$
  % es una tupla conformada por el hash del lote que contiene a $e$
  % y una firma válida para el mismo-, revirtió $h$ correctamente y, como consecuencia,
  % añadió a $e$ a \THESET (ver línea \ref{line:abci-hashchain-the-set}).

...
\begin{itemize}
  ...
  elementos que provienen del conjunto de solo crecimiento. \textbf{Demostración}. Esto es trivialmente correcto debido a que la
  ...
  servidor correcto $v$ es eventualmente retornado en todas las llamadas futuras a $v$.\<get>. \textbf{Demostración}.
  \item La \textit{Propiedad 3 (Get-Global)} establece que los elementos presentes en un servidor correcto
  son propagados a todos los servidores correctos. \textbf{Demostración}. Si un servidor correcto devuelve un elemento $e$ como parte de $\THESET$,
  ...
  añadiéndo a $e$ a su conjunto $\THESET$.
  \item La \textit{Propiedad 4 (Eventual-Get)} establece que todos los elementos añadidos son eventualmente estampados
  con un número de época. \textbf{Demostración}.
  \item La \textit{Propiedad 5 (Unique Epoch)} establece que un elemento puede estar en a lo sumo una época. \textbf{Demostración}.
  \item La \textit{Propiedad 6 (Consistent Gets)} establece que los servidores están de acuerdo en el contenido
  de las épocas. \textbf{Demostración}.
  \item La \textit{Propiedad 7 (Add-before-Get)} determina que todo elemento en $\HISTORY$ provenga del resultado de un cliente
  añadiendo un elemento. \textbf{Demostración}. Esta propiedad no se va a cumplir.

...
\begin{figure}
  ...
  \subfloat[$e$ se chequea contra \CheckTx]{\includegraphics[width = 3.5in]{figures/vanilla-flow-3.png}}
  ...
  \caption{Flujo usual de mensajes}
...
\subsubsection{Ataques front-running}

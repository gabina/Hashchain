...
empaquetar elementos en un lote, formando un conjunto y comprimiéndolo
...
es responsable de recolectar elementos hasta llegar a un lote suficientemente grande,
...
\begin{figure}
  ...
  \subfloat[El cliente invoca \Add(e)]{\includegraphics[width = 3.5in]{figures/compresschain-flow-2.png}}\\
  ...
  \subfloat[Se agrega la época $n$ a la \setchain]{\includegraphics[width = 3.5in]{figures/compresschain-flow-6.png}} 
  \caption{Flujo usual de mensajes para compresschain}
  \label{fig:vanilla-flow}
\end{figure}

Siguiendo la práctica actual de Ethereum, se utiliza el algoritmo de codificación
\textit{Recursive Length Prefix} (RLP)~\cite{ethereum}
y el algoritmo de compresión Brotli~\cite{brotli.compressor}.
...
primero se recolectan y se codifican utilizando RLP y, una vez que el lote está listo,
se comprime con el agoritmo de compresión Brotli.
%
...
\subsection{Detalles de implementación}\label{subsubsec:details}

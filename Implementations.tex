...
\begin{figure}
  \subfloat[fig 1]{\includegraphics[width = 3in]{figures/vanilla-flow-0.png}} 
  \subfloat[fig 2]{\includegraphics[width = 3in]{figures/vanilla-flow-1.png}}\\
  \subfloat[fig 3]{\includegraphics[width = 3in]{figures/vanilla-flow-2.png}}
  \subfloat[fig 4]{\includegraphics[width = 3in]{figures/vanilla-flow-3.png}} 

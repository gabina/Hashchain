...
le solicitó revertir un hash, se comunica con el \hcollector correspondiente, en función de clave
...
%
Cada una de ellas se añade a la base de datos a medida que se crean nuevos hashes
o se descubren por medio de otro \hcollector.
%
Dicha base de datos persistente se implementa como una base de datos de tipo clave-valor, utilizando el paquete
\textit{BadgerDB}.
%

...
El \collector es quien se encarga de 

%

\begin{figure}
  %\subfloat[Estado inicial]{\includegraphics[width = 3.5in]{figures/hash-reversal-0.png}}\\
  \subfloat[El cliente invoca \Add(e)]{\includegraphics[width = 3.5in]{figures/hash-reversal-1.png}}\\
  \subfloat[$t_e$ se chequea contra \CheckTx]{\includegraphics[width = 3.5in]{figures/hash-reversal-2.png}}\\
  \subfloat[Se consensúa el próximo bloque]{\includegraphics[width = 3.5in]{figures/hash-reversal-3.png}}\\
  \subfloat[Se envían los pedidos de la ABCI a la aplicación]{\includegraphics[width = 3.5in]{figures/hash-reversal-4.png}}
  \caption{Flujo usual de mensajes para vainilla}
  \label{fig:vanilla-flow}
\end{figure}

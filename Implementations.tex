...
El \collector mismo es quien se encarga de conseguir el lote asociado a un hash.
%
...
\begin{figure}
  ...
  \subfloat[El \collector conoce el hash]{\includegraphics[width = 3.5in]{figures/hash-reversal-2.png}}\\
  \subfloat[El \collector no conoce el hash]{\includegraphics[width = 3.5in]{figures/hash-reversal-3.png}}\\

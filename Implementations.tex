...
\setchain y, por el otro, la interfaz de aplicación de blockchain ~(ver sección ~\ref{sec:prelim}).
...
debe definir la interfaz ABCI (ver sección~\ref{subsec:abci}). 
%
...
y cuando se haga \textit{commit} sobre dicho bloque (como parte del consenso), Tendermint enviará
...
consensuadas)\footnote{En esta implementación
una \textit{transacción} agregada coincide con un \textit{elemento} agregado.},
\EndBlock para indicar la finalización del bloque, y \Commit para señalizar que el estado

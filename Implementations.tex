...
%
Se utilizó la implementación nativa de Tendermint del cliente HTTP,
...
es la implementación que probablemente sea más razonable de utilizar en un entorno
real, y es por eso que fue elegida para este trabajo.

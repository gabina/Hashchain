...
\begin{figure}
  ...
  \caption{Flujo usual de mensajes para \hashchain}
...
de \compresschain.
%
La comunicación entre la aplicación y el \hashcollector se hace también de la misma manera.
%


La implementación del \hcollector involucra una base de datos persistente capaz de almacenar ¿Cómo se comunica un collector con otro? ¿Cómo se maneja el tema de las claves?
¿Cómo se guardan los mapeos de hashes a elementos en base de datos consistente?

...
%
Conecta varias blockchains (o zonas) mediante un protocolo de comunicación entre blockchains (IBC),
funcionando como un protocolo TCP para blockchains\footnote{El protocolo de control de transmisión conocido como

...
\begin{itemize}
  ...
  de transmitirse como una transacción. Luego, las transacciones en la blockchain son
  ...
  en donde los elementos se agrupan y se les aplica una función hash antes de ser transmitidos

...
\begin{itemize}
  ...
  en la cual muchos elementos pertenecientes a una misma época de la \setchain se insertan
  comprimidos en la blockchain como una única transacción.
  ...
  en donde las transacciones en la blockchain son
  hashes de lotes de elementos de la \setchain pertenecientes a una misma época.
\end{itemize}
%

...
%con la implementación de Bitcoin, un sistema de pago electrónico descentralizado, 
%propuesto por Nakamoto en 2008~\cite{nakamoto06bitcoin}.
...
de los demás.
%
La \textit{inter-operabilidad} de blockchains es la habilidad de conectar mútiples redes de

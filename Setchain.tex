...
de $v$.
%
En dicho estado, la invocación $v$.\<get> por parte de un cliente resulta en la terna 

\[ (v.\THESET, v.\HISTORY, v.\EPOCH) \]
donde
\[ v.\THESET = \{x, y, z, w, m, n\}, \ v.\HISTORY = \{1: \{x, y, z\}, 2: \{w\}, 3: \{m, n\}\}, \ v.\EPOCH = 3 \]
...
de ser estampados (en este caso $a$ y $b$).
%
De este modo, se tiene
\[ v.\<get> = (\{x, y, z, w, m, n, a, b\}, \{1: \{x, y, z\}, 2: \{w\}, 3: \{m, n\}, 4: \{a, b\}\}, 4) \]


\begin{figure}
  \centering
  \subfloat[Estado de la \setchain según $v$]{\includegraphics[width = 5in]{figures/setchain_api_0.png}\label{subfig:setchain-api-0}}\\
  \bigskip
  \subfloat[Un cliente invoca $v$.\<add>(a)]{\includegraphics[width = 5in]{figures/setchain_api_1.png}\label{subfig:setchain-api-1}}\\
  \bigskip
  \subfloat[Un cliente invoca $v$.\<add>(b)]{\includegraphics[width = 5in]{figures/setchain_api_2.png}\label{subfig:setchain-api-2}}\\
  \bigskip
  \subfloat[Ocurre un nuevo incremento de época]{\includegraphics[width = 5in]{figures/setchain_api_3.png}\label{subfig:setchain-api-3}}

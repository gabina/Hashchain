...
Informalmente, un proceso cliente $p$ invoca $v.\<get>()$ sobre un servidor $v$ para obtener $(v.\THESET, v.\HISTORY, v.\EPOCH)$:
...
\begin{figure}
  ...
  \bigskip
  \subfloat[Un cliente invoca $v$.\<add>(b)]{\includegraphics[width = 5in]{figures/setchain_api_22.png}\label{subfig:setchain-api-2}}\\
  \bigskip
  \subfloat[Ocurre un nuevo incremento de época]{\includegraphics[width = 5in]{figures/setchain_api_32.png}\label{subfig:setchain-api-3}}
